...
- The **14 currently-planned presentational wrappers** are kbd, steps, stepper, reactions, attachment, audit-log,
  notification-center, pipeline, flow, sla, heartbeat, media, lightbox, and contact-card. In addition, calendar,
  file-upload, slider, tag-input, menu, and chart remain Planned; those need real behaviour, not just a class wrapper.
