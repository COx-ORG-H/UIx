...
export const COMPONENT_GUIDANCE = {
  ...
  arrival: ['Show where a link or a search result landed.', 'The target is tinted for about two seconds and fades; with reduced motion it is outlined instead.'],
  ...
  'rich-text': ['Write formatted long text — descriptions, work notes, articles — without knowing markdown.', 'A toolbar and formatted editing surface that stores markdown; untouched text is saved byte-for-byte.'],
